...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const inputWrapperStyle: React.CSSProperties = {
      ...
      boxShadow: isFocused ? `0 0 0 3px ${hasError ? theme.colors.danger.default : theme.colors.border.focus}26` : theme.shadows.sm,
      ...
      <div style={wrapperStyle} className={className}>
        ...
        <div style={inputWrapperStyle}>
          ...
          <input
            ...
            {...props}
          />
          {suffix && <span style={{ ...adornmentStyle, paddingLeft: theme.spacing[2], paddingRight: config.paddingX }}>{suffix}</span>}
        </div>
